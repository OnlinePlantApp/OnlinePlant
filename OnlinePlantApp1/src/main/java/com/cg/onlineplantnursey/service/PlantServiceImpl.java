...
import com.cg.onlineplantnursey.repository.IPlantRepository;
...
public class PlantServiceImpl implements IPlantService{
	...
	public List<Plant> viewPlant(String commonName) throws PlantIdNotFoundException {
		...
		List<Plant> plant = plantRepo.getPlantByCommonName(commonName);
	...
	@Override
	public List<Plant> getAllPlantByTypeOfPlants(String typeOfPlant) throws PlantIdNotFoundException{
		// TODO Auto-generated method stub
		
		List<Plant> obj2 = plantRepo.getAllPlantsByTypeOfPlants(typeOfPlant);
		if(obj2.size()>0)
		{
			return obj2;
